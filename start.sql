...
create property Requirements.range string;
...
insert into Requirements (name, level, definition, linkName, type, range) values 
('accountability', 1, 'This category contains attributes used to measure the properties related to the cloud service provider organization. These properties may be independent of the service being provided.', 'accountability', 'slider', 'min: 0, max: 100');

insert into Requirements (name, level, definition, linkName, type, range) values 
('agility', 1, 'Indicates the impact of a service upon a client\u2019s ability to change direction, strategy, or tactics quickly and with minimal disruption.','agility' ,'slider', 'min: 0, max: 100');

insert into Requirements (name, level, definition, linkName, type, range) values 
('assurance', 1, 'This category includes key attributes that indicate how likely it is that the service will be available as specified.','assurance','slider', 'min: 0, max: 100');

insert into Requirements (name, level, definition, linkName, type, range) values 
('financial', 1, 'The amount of money spent on the service by the client.', 'financial', 'slider', 'min: 0, max: 100');

insert into Requirements (name, level, definition, linkName, type, range) values 
('performance', 1, 'This category covers the features and functions of the provided services.','performance', 'slider', 'min: 0, max: 100');

insert into Requirements (name, level, definition, linkName, type, range) values 
('security and privacy', 1, 'This category includes attributes that indicate the effectiveness of a cloud service provider\u2019s controls on access to services, service data, and the physical facilities from which services are provided.','securityAndPrivacy', 'slider', 'min: 0, max: 100');

insert into Requirements (name, level, definition, linkName, type, range) values 
('usability', 1, 'The ease with which a service can be used.','usability','slider', 'min: 0, max: 100');
